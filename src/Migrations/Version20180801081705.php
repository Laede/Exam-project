 ...
 */
final class Version20180801081705 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, DROP post_date');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD post_date VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP created_at, DROP updated_at');
    }
}
